...
export const ui = {
  es: {
    ...
    contacto: {
      ...
      formSub: "Rellena tus datos y te abrimos WhatsApp con el mensaje listo: solo pulsa enviar.",
      labelName: "Nombre",
      phName: "Tu nombre",
      labelPhone: "Teléfono",
      phPhone: "600 000 000",
      ...
      statusOk: "Te hemos abierto WhatsApp con tu mensaje. Pulsa enviar y te contestamos enseguida.",
    ...
    chat: {
      ...
      waCta: "Continuar por WhatsApp",
      waIntro: "¡Hola Escalat! Soy",
      waInterest: "Me interesa:",
      waContact: "Mi contacto:",
    },
  ...
  en: {
    ...
    contacto: {
      ...
      formSub: "Fill in your details and we'll open WhatsApp with the message ready: just tap send.",
      labelName: "Name",
      phName: "Your name",
      labelPhone: "Phone",
      phPhone: "600 000 000",
      ...
      statusOk: "We've opened WhatsApp with your message. Tap send and we'll get back to you shortly.",
